      ...
      'instantiate': function (___, IMPORTS___) {
        ...
        var moduleResult___;
        {
          function TamingMembrane(privilegedAccess, schema) {
            ...
            getTameProperty, setTameProperty, copyTreatedImmutable, copyTArray,
            copyTreatedMutable, makeNeutralException, tameException,
            untameException, tamesTo, reTamesTo, tameArray, untameArray,
            errGet, errSet, tame, isValidPropertyName, tameRecord,
            tamePreviouslyConstructedObject, addFunctionPropertyHandlers,
            tamePureFunction, tameCtor, tameXo4a, makePrototypeMethod,
            makeStrictPrototypeMethod, inheritsFrom, makePropertyGetter,
            makePropertySetter, defineObjectProperty, tameObjectWithMethods,
            untame, untameCajaFunction, untameCajaRecord,
            untameCajaRecordByEvisceration, untameCajaRecordByPropertyHandlers,
            hasTameTwin, hasFeralTwin, x6___, x7___;
            {
            ...
            }
            {
              function copyTreatedImmutable(o) {
                ...
                case '[object Number]':
                  t = new (IMPORTS___.Number_v___? IMPORTS___.Number:
                    ___.ri(IMPORTS___, 'Number')).new___((+
                      (privilegedAccess.getValueOf_m___?
                       privilegedAccess.getValueOf(o):
                       privilegedAccess.m___('getValueOf', [ o ]))));
                  break;
                ...
                case '[object String]':
                  t = new (IMPORTS___.String_v___? IMPORTS___.String:
                    ___.ri(IMPORTS___, 'String')).new___(('' +
                      (privilegedAccess.getValueOf_m___?
                       privilegedAccess.getValueOf(o):
                       privilegedAccess.m___('getValueOf', [ o ]))));
                  break;
              ...
              ___.f(copyTreatedImmutable, 'copyTreatedImmutable');
            }
            {
              function copyTArray(ctor, o) {
                var byteOffset, byteLength, buffer, x0___, x1___, x2___, x3___,
                x4___, x5___;
                byteOffset = + (o.byteOffset_v___? o.byteOffset:
                  o.v___('byteOffset'));
                byteLength = + (o.byteLength_v___? o.byteLength:
                  o.v___('byteLength'));
                buffer = (x2___ = (x1___ = (x0___ =
                      IMPORTS___.ArrayBuffer_v___? IMPORTS___.ArrayBuffer:
                      ___.ri(IMPORTS___, 'ArrayBuffer'), x0___.prototype_v___?
                      x0___.prototype: x0___.v___('prototype')),
                    x1___.slice_v___? x1___.slice: x1___.v___('slice')), x3___
                  = o.buffer_v___? o.buffer: o.v___('buffer'), x4___ =
                  o.byteOffset_v___? o.byteOffset: o.v___('byteOffset'), x5___
                  = (o.byteOffset_v___? o.byteOffset: o.v___('byteOffset')) +
                  (o.byteLength_v___? o.byteLength: o.v___('byteLength')),
                  x2___.call_m___? x2___.call(x3___, x4___, x5___):
                  x2___.m___('call', [ x3___, x4___, x5___ ]));
                return new ctor.new___(buffer);
              }
              ___.f(copyTArray, 'copyTArray');
            }
            {
              function copyTreatedMutable(o, recursor) {
                var t, x0___, x1___, x2___, x3___, x4___, x5___, x6___, x7___;
                {
                  t = IMPORTS___.undefined_v___? IMPORTS___.undefined:
                  ...
                  case '[object ArrayBuffer]':
                    t = (x6___ = (x5___ = (x4___ = IMPORTS___.ArrayBuffer_v___?
                          IMPORTS___.ArrayBuffer: ___.ri(IMPORTS___,
                            'ArrayBuffer'), x4___.prototype_v___?
                          x4___.prototype: x4___.v___('prototype')),
                        x5___.slice_v___? x5___.slice: x5___.v___('slice')),
                      x7___ = o, x6___.call_m___? x6___.call(x7___, 0):
                      x6___.m___('call', [ x7___, 0 ]));
                    break;
                  case '[object Int8Array]':
                    t = copyTArray.i___(IMPORTS___.Int8Array_v___?
                      IMPORTS___.Int8Array: ___.ri(IMPORTS___, 'Int8Array'), o)
                      ;
                    break;
                  case '[object Uint8Array]':
                    t = copyTArray.i___(IMPORTS___.Uint8Array_v___?
                      IMPORTS___.Uint8Array: ___.ri(IMPORTS___, 'Uint8Array'),
                      o);
                    break;
                  case '[object Uint8ClampedArray]':
                    t = copyTArray.i___(IMPORTS___.Uint8ClampedArray_v___?
                      IMPORTS___.Uint8ClampedArray: ___.ri(IMPORTS___,
                        'Uint8ClampedArray'), o);
                    break;
                  case '[object Int16Array]':
                    t = copyTArray.i___(IMPORTS___.Int16Array_v___?
                      IMPORTS___.Int16Array: ___.ri(IMPORTS___, 'Int16Array'),
                      o);
                    break;
                  case '[object Uint16Array]':
                    t = copyTArray.i___(IMPORTS___.Uint16Array_v___?
                      IMPORTS___.Uint16Array: ___.ri(IMPORTS___, 'Uint16Array')
                      , o);
                    break;
                  case '[object Int32Array]':
                    t = copyTArray.i___(IMPORTS___.Int32Array_v___?
                      IMPORTS___.Int32Array: ___.ri(IMPORTS___, 'Int32Array'),
                      o);
                    break;
                  case '[object Uint32Array]':
                    t = copyTArray.i___(IMPORTS___.Uint32Array_v___?
                      IMPORTS___.Uint32Array: ___.ri(IMPORTS___, 'Uint32Array')
                      , o);
                    break;
                  case '[object Float32Array]':
                    t = copyTArray.i___(IMPORTS___.Float32Array_v___?
                      IMPORTS___.Float32Array: ___.ri(IMPORTS___,
                        'Float32Array'), o);
                    break;
                  case '[object Float64Array]':
                    t = copyTArray.i___(IMPORTS___.Float64Array_v___?
                      IMPORTS___.Float64Array: ___.ri(IMPORTS___,
                        'Float64Array'), o);
                    break;
                  case '[object DataView]':
                    t = new (IMPORTS___.DataView_v___? IMPORTS___.DataView:
                      ___.ri(IMPORTS___, 'DataView'))
                      .new___((recursor.i___(o.buffer_v___? o.buffer:
                          o.v___('buffer'))), (o.byteOffset_v___? o.byteOffset:
                        o.v___('byteOffset')), (o.byteLength_v___?
                        o.byteLength: o.v___('byteLength')));
                    break;
                  }
                  return t;
                }
              }
              ___.f(copyTreatedMutable, 'copyTreatedMutable');
            }
            {
            ...
            {
              function tame(f) {
                var t, x0___, x1___, ftype, ctor, x2___, x3___, x4___, x5___,
                ...
                ftype = typeof f;
                if (ftype === 'object') {
                  t = copyTreatedMutable.i___(f, tame);
                  if (t) { return t; }
            ...
            {
              function untame(t) {
                var f, x0___, x1___, ttype, ctor, x2___, x3___;
                ...
                feralByTame.m___('get', [ t ]);
                if (f) { return f; }
                f = copyTreatedMutable.i___(t, untame);
                if (f) { return f; }
...
'cajolerVersion': 'v6011-es53',
'cajoledDate': 1513690678441
});
}